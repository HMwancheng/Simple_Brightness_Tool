...
namespace SimpleBrightness
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            using (Mutex mutex = new Mutex(false, "Global\\" + "HMSimpleBrightness_v38_Split_Core"))
            {
    ...
    public class MyCustomApplicationContext : ApplicationContext
    {
        ...
        private void ShowUnifiedOsd(string activeId)
        {
            ...
            if (_unifiedOsd.InvokeRequired) _unifiedOsd.Invoke(new Action(() => _unifiedOsd.UpdateDisplay(activeId)));
            else _unifiedOsd.UpdateDisplay(activeId);
        }
