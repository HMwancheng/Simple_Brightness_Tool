...
namespace SimpleBrightness
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            // 互斥体防止多开
            using (Mutex mutex = new Mutex(false, "Global\\" + "HMSimpleBrightness_v24_FinalFixed"))
            {
    ...
    public class MyCustomApplicationContext : ApplicationContext
    {
        ...
        {
            // 逻辑：1. 必须在图标上(区域检测) 2. 必须在活跃时间内(超时检测)
    ...
    public class OsdForm : Form { 
        ...
        public void ShowOSD(int value, bool isDebug, int realVal) { 
            _targetValue = value; 
            if (isDebug) { _monitorName += " [DEBUG]"; _targetValue = realVal; } 
        ...
        protected override void OnPaint(PaintEventArgs e) { 
            ...
            TextRenderer.DrawText(e.Graphics, $"{_targetValue}%", new Font("Segoe UI", 12, FontStyle.Bold), new Point(160, 0), Color.White); 
        } 
    }

    // ================== 6. BrightnessForm (主界面) ==================
