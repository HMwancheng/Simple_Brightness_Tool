...
namespace SimpleBrightness
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            // 互斥体防止多开
            using (Mutex mutex = new Mutex(false, "Global\\" + "HMSimpleBrightness_v26_Final"))
            {
    ...
    public class MyCustomApplicationContext : ApplicationContext
    {
        ...
        private void OnGlobalMouseWheel(object? sender, MouseEventArgs e)
        {
            ...
            {
                _lastIconHoverTime = DateTime.Now; // 续命
    ...
    // ================== 9. UI Classes (BrightnessForm, CurveEditor, etc) ==================
    ...
    public class CurveEditorForm : Form { 
        ...
        private Control CreateItem(int x, int y) { 
            ...
            int sliderTop = 45; int sliderBottom = (x!=0&&x!=100) ? 270 : 290; TrackBar t = new TrackBar { Orientation = Orientation.Vertical, Minimum = 0, Maximum = 100, Value = y, Top = sliderTop, Height = sliderBottom - sliderTop, Width = 45, Left = 12, TickStyle = TickStyle.None }; 
